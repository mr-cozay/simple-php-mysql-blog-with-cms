...
<form action="" method="post" enctype="multipart/form-data">
        ...
        <select name="post_status">
            ...
            <?php
                if ($post_status == 'published') {
                    ...
                    echo "<option value='published'>Publié</option>";
                }
            ?>
        </select>
    </div>
    ...
    <div class="form-group">
        <input type="submit" class="btn btn-primary" name="update_post" value="Mettre à jour">
    </div>
...
<?php
    if (isset($_POST['create_post'])) {
        if ($result) {
            echo "<h4>Article modifié avec succès</h4>";
        }
    }
?>