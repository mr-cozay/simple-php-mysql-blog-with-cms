...
-- Listage de la structure de la base pour simple_php_mysql_blog_with_cms
CREATE DATABASE IF NOT EXISTS `simple_php_mysql_blog_with_cms` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `simple_php_mysql_blog_with_cms`;

-- Listage de la structure de la table simple_php_mysql_blog_with_cms. categories
...
-- Listage des données de la table simple_php_mysql_blog_with_cms.categories : ~3 rows (environ)
...
-- Listage de la structure de la table simple_php_mysql_blog_with_cms. comments
...
-- Listage des données de la table simple_php_mysql_blog_with_cms.comments : ~1 rows (environ)
...
-- Listage de la structure de la table simple_php_mysql_blog_with_cms. posts
...
-- Listage des données de la table simple_php_mysql_blog_with_cms.posts : ~1 rows (environ)
...
-- Listage de la structure de la table simple_php_mysql_blog_with_cms. users
...
-- Listage des données de la table simple_php_mysql_blog_with_cms.users : ~1 rows (environ)
